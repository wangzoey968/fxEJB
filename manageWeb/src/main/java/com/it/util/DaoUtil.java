...
/**
 * Created by wangzy on 2018/5/21.
 */
public class DaoUtil {
    ...
    public DaoUtil(SessionFactory sf) {
        sessionFactory = sf;
    }

    public DaoUtil(JdbcTemplate template) {
        jdbcTemplate = template;
    }

    public DaoUtil(SessionFactory sf, JdbcTemplate template) {
        sessionFactory = sf;
        jdbcTemplate = template;
    }
