$(function () {
    ...
    var _zhanBanParam = {
        'paperType': null, 'width': null, 'height': null,'amount': 1, 'typeAmount': 1,'fuMo':false,'fuMoCaiLiao':'哑膜','jingXiManPen':false,'daKou':false,
        'daKouType':'','baoBian':false,'baoBianType':''
    };
    ...
    var papers = [];
    var paperMap = {
        '户外车贴展板':'户外车贴展板','户外背胶展板': '户外背胶展板', '户外车贴PVC板3mm': '户外车贴PVC板3mm','户外车贴PVC板5mm':'户外车贴PVC板5mm',
        '户外背胶PVC板3mm':'户外背胶PVC板3mm','户外背胶PVC板5mm': '户外背胶PVC板5mm'
    };
    ...
    _control.orderTextGroup($('.zhanBanCalPrice #fuMo-group'), ['光膜','哑膜'], function (text) {
        ...
        _zhanBanParam.fuMoCaiLiao = text;
        $("#orderDesc").text(getDesc(_zhanBanParam));
        sendRequest(_zhanBanParam);
    });
    //超精细慢喷
    ...
    function getDesc(value) {
        ...
        var postDesc = '';
        valueObj.fuMo ? postDesc += valueObj.fuMoCaiLiao+ '，' : null;
        valueObj.jingXiManPen ? postDesc += '超精细慢喷，' : null;
    ...
    function sendRequest(request_param) {
        ...
        $.ajax({
            ...
            data: {productJson: JSON.stringify(request_param), orderType: "户外展板"},
            dataType: 'json',
            /*async: false,*/
            type: 'POST',
            beforeSend:function () {
    ...
    $("#fileUpload").click(function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {typeAmount:_zhanBanParam.typeAmount,productContent:JSON.stringify(_zhanBanParam),orderTitle:fileValue.name,orderType:'户外展板'},
            dataType: _json,
